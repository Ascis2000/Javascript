	...
	data: [
		...
		{ 
			...
			respuesta: `
					...
					se enlaza dinámicamente en tiempo de ejecución según el contexto en el que se invoca la función.<br/><br/>
		...
		{ 
			...
			respuesta: `
					Los dos parámetros son <b>resolve</b> que se utiliza para resolver la promesa satisfactoriamente 
					y <b>reject</b> que se utiliza para rechazar la promesa
					` 
		},
        { 
			pregunta: '¿Es correcta la siguiente sentencia: <b>getElementsById()</b>?', 
			respuesta: `No, getElementsById() es incorrecto y debería ser getElementById(), ya que 
            este método del objeto 'document' solamente obtiene un identificador único
            ` 
		},
		{ 
		...
		{ 
			pregunta: 'Cuál es el resultado siguiente: <b>1 + 2 + "8"</b>?', 
			respuesta: `
				el resultado sería "38"<br/> 
				(1 + 2) + "8" -> 3 + "8" -> "38"
				`
		},
		{ 
        ...
        { 
			pregunta: '¿Qué hace el <b>Object.assign(target, source)</b>, en donde target = {a:1, b:2} y source = {b:4, c:5}?', 
			respuesta: `
				es un método de Object que copia las propiedades de uno o más objetos de origen a un objeto de destino. <br/>
                Esta función modifica y retorna el objeto de destino. <br/>
                El resultado sería <b>{a:1, b:4, c:5}</b>
				`
		},
		{ 
